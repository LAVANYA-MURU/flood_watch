...
/**
 * Get color based on risk level from map_data
 */
function getCircleColor(riskColor) {
    const colors = {
        'green': '#22c55e',
        'orange': '#eab308',
        'red': '#ef4444'
...
function renderMapCircles(zones) {
    ...
    zones.forEach(zone => {
        ...
        const riskColor = mapData.risk_color || 'green';
        const heatIntensity = mapData.heat_intensity || 0.5;
        const color = getCircleColor(riskColor);
